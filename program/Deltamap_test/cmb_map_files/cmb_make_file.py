...
# 3*nside - 1 から　2*nside　に変更

def cmb_make_file(nside, r_input, random_seed_cmb, seed_syn):

    #Set up a new set of parameters for CAMB
    pars = camb.read_ini('/Users/ikumakiyoshi/Library/Mobile Documents/com~apple~CloudDocs/study_fg_rm/program/Deltamap_test/julia_delta-map/params_camb_for_PTEP.ini')
    ...
    CMB_name = f"{r_n}{r_input}{nside_n}{nside}{seed}{random_seed_cmb}"
    
    np.save(CMB_name, cmb_map)

    hp.fitsfunc.write_map(CMB_name, cmb_map, overwrite=True)
