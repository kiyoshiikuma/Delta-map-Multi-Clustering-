...
#=================注意======================#
# smoothing　後に　maskするので気をつける
#===========================================#

function minimize_function_chi_sq(beta_s, r, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)
    ...
    smootinhg_x_map = sm.smootinhg_map(xx_map, nside)

    smoosthing_masked_x_map_Q = [smootinhg_x_map[2,:][i] for i in 1:length(smootinhg_x_map[2,:]) if mask_map[i] == 1]
    smoosthing_masked_x_map_U = [smootinhg_x_map[3,:][i] for i in 1:length(smootinhg_x_map[3,:]) if mask_map[i] == 1]

    x_map_Q_U = [smoosthing_masked_x_map_Q ; smoosthing_masked_x_map_U]
    x_with_noise =  x_map_Q_U + noise_map;
...
function minimize_function_like(r, beta_s, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)
...
function minimize_function_chi_sq_s1(beta_s, r, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)
...
function minimize_function_chi_sq_d1_and_d1_s1(beta_s, r, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)
...
function minimize_function_like_free(r, beta_s, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)
...
function r_like_estimate_fast(r_ini, num_iterations, accuracy_r, accuracy_like, random_seed_cmb, seed_syn, nside, r_input, freq_band, which_model, cmb_freq, cov_mat_scal, cov_mat_tens)
    ...
    # chi二乗
    minimize_function_chi_sq_new(beta_s, r) = minimize_function_chi_sq(beta_s, r, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)

    # likelihood
    minimize_function_like_new(r, beta_s) = minimize_function_like(r, beta_s, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)
...
function minimize_r_like_estimate_fast(r_ini, num_iterations, accuracy_r, accuracy_like, random_seed_cmb, seed_syn, nside, r_input, freq_band, which_model, cmb_freq, cov_mat_scal, cov_mat_tens)
    ...
    # chi二乗
    minimize_function_chi_sq_s1_new(beta_s, r, beta_d, T_d) = minimize_function_chi_sq_s1(beta_s, r, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)

    minimize_function_chi_sq_d1_and_d1_s1_new(beta_s, r, beta_d, T_d) = minimize_function_chi_sq_d1_and_d1_s1(beta_s, r, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)

    # likelihood
    minimize_function_like_free_new(r, beta_s, beta_d, T_d) = minimize_function_like_free(r, beta_s, cov_mat_scal, cov_mat_tens, noise_map, art_noise_cov_mat, freq_band, cmb_freq, nside, cmb_data, which_model, freq_bs, freq_bd, beta_d, T_d, mask_map)
